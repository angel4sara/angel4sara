...
I am a Data Analyst with an MSc in Data Science, Microsoft Certified: Power BI Data Analyst Associate and experience delivering data-driven solutions across higher education, healthcare, and business domains. My expertise includes SQL, Python, Power BI, Snowflake, Tableau, Alteryx, Azure, and Excel, with a strong focus on data cleaning, transformation, visualisation, and predictive analytics. I have developed interactive dashboards, ETL process, machine learning models, and reporting solutions that support strategic decision-making. My recent work includes building a university-wide EDI analytics platform at UCL, developing healthcare and workforce analytics dashboards, and delivering data quality and migration projects within academic institutions. I am passionate about turning complex datasets into actionable insights and continuously expanding my knowledge in Azure Data Engineering, Advanced SQL, Data Governance, and Machine Learning.
